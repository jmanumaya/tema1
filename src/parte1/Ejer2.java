...
public class Ejer2 {
	...
	public static void main(String[] args) {
		...
		// Creo la variable edad de tipo entero para luego albergar el número que escriba el usuario.
		int edad;
		
		// Le indico al usuario que introduzca su edad.
		System.out.print("Hola!! Escribe tu edad y te diré cuantos años tendrás el año que viene: ");
		...
		System.out.println("Tendrás: " + ++edad + " años");
